...
public class ViewPanelEntrada extends JFrame {
    ...
    private JLabel campoDeBúsquedaLabel;

    private JButton añadirEstudiante;
    private JButton eliminarEstudiante;


    private JButton modificarPersonaButton;


    public ViewPanelEntrada() {

        super("Proyecto final Java");
    ...
    public JButton getAñadirEstudiante() {
        return añadirEstudiante;
    }

    public JButton getEliminarEstudianteButton() {
        return eliminarEstudiante;
    }
    public JButton getModificarPersonaButton() {
        return modificarPersonaButton;
    }
